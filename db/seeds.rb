...
map = Addon.create(name: "Questie", description: "This addon will allow the user to quest with utter ease. From level 1 to 60 this will get you from point A to point B with ease", category: "Maps", support: "Version 1.12.1", category_id: 1, image: "http://i.imgur.com/qbTepxD.png", dtime: 20)
...
bagnon = Addon.create(name: "Bagnon", description: "agnon merges all of your bags into three windows: inventory, bank and guild bank. Beyond the basic all-in-one functionality", category: "Bags", support: "Version 1.12.1", category_id: 7, image: "http://media-curse.cursecdn.com/attachments/74/147/4218c641028da24d233f5d25e6803d51.jpeg", dtime: 30)
map = Addon.create(name: "Questie", description: "This addon will allow the user to quest with utter ease. From level 1 to 60 this will get you from point A to point B with ease", category: "Maps", support: "Version 1.12.1", category_id: 1, image: "http://i.imgur.com/qbTepxD.png", dtime: 10)
map = Addon.create(name: "Questie", description: "This addon will allow the user to quest with utter ease. From level 1 to 60 this will get you from point A to point B with ease", category: "Maps", support: "Version 1.12.1", category_id: 1, image: "http://i.imgur.com/qbTepxD.png", dtime: 5)
